...
from app.routers import device, health, hyperspectral, pest_detection, predict
...
app.include_router(pest_detection.router, prefix=settings.API_V1_STR, tags=["PestDetection"])
